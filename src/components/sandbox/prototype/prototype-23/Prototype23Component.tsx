 ...
 * @todo Document this
 */
export interface Prototype23ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype23Component: React.FC<Prototype23ComponentProps> = (props) => {
...
Prototype23Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype23Component;
