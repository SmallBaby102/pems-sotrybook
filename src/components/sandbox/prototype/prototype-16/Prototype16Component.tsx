 ...
 * @todo Document this
 */
export interface Prototype16ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype16Component: React.FC<Prototype16ComponentProps> = (props) => {
...
Prototype16Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype16Component;
