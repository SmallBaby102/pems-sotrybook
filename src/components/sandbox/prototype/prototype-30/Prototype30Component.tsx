 ...
 * @todo Document this
 */
export interface Prototype30ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype30Component: React.FC<Prototype30ComponentProps> = (props) => {
...
Prototype30Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype30Component;
