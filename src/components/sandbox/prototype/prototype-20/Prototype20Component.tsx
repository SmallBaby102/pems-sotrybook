 ...
 * @todo Document this
 */
export interface Prototype20ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype20Component: React.FC<Prototype20ComponentProps> = (props) => {
...
Prototype20Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype20Component;
