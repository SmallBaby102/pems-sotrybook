 ...
 * @todo Document this
 */
export interface Prototype29ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype29Component: React.FC<Prototype29ComponentProps> = (props) => {
...
Prototype29Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype29Component;
