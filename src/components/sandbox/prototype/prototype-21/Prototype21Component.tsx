 ...
 * @todo Document this
 */
export interface Prototype21ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype21Component: React.FC<Prototype21ComponentProps> = (props) => {
...
Prototype21Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype21Component;
