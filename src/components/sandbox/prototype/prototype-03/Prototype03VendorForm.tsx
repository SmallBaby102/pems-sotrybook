...
const Prototype03VendorForm: React.FC = () => {
        ...
        <div>
            ...
            <div>
                ...
                <Prototype03Input
                    ...
                    onChange={e => setVendorForm({ ...vendorForm, businessCat: e.target.value })}
                ...
                <Prototype03Input
                    ...
                    onChange={e => setVendorForm({ ...vendorForm, password2: e.target.value })}
            ...
            <div className="w-[70%] my-[60px] mx-auto">
                <Prototype03Button caption="NEXT" type={1} disabled={!stage.selector} onClick={() => stageHandle("Landing")} />
            </div>
        </div>
    );
};

export default Prototype03VendorForm;