...
const Prototype03DrawerComponent: React.FC<PropTypes> = (props: PropTypes) => {
                ...
                >
                    ...
                    <div className='flex items-center'>
                        <div className='flex-1 lg:font-bold text-[25px] flex items-center gap-3'>
                            <div className='text-[#F7074F]'>
                                {props.title}
                            </div>
                        </div>
                        <div className="text-right">
                            <button onClick={props.onHide} className="hidden lg:block">
...
export default Prototype03DrawerComponent;
