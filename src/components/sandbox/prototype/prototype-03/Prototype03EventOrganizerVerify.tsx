...
const Prototype03EventOrganizerVerify: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className="w-[70%] mt-[180px] mx-auto">
                <Prototype03Button caption="SEARCH" type={1} disabled={!stage.selector} onClick={() => stageHandle("Landing")} />
            </div>
...
export default Prototype03EventOrganizerVerify;