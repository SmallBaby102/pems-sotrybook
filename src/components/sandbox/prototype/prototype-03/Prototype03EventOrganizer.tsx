...
const Prototype03EventOrganizer: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className="w-[70%] mt-[60px] mx-auto">
                <Prototype03Button caption="SEARCH" type={1} disabled={!stage.selector} onClick={() => stageHandle("EventOrgVerify")} />
            </div>
...
export default Prototype03EventOrganizer;