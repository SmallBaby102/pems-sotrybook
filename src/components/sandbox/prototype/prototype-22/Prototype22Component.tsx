 ...
 * @todo Document this
 */
export interface Prototype22ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype22Component: React.FC<Prototype22ComponentProps> = (props) => {
...
Prototype22Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype22Component;
