 ...
 * @todo Document this
 */
export interface Prototype14ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype14Component: React.FC<Prototype14ComponentProps> = (props) => {
...
Prototype14Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype14Component;
