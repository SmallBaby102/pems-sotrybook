 ...
 * @todo Document this
 */
export interface Prototype13ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype13Component: React.FC<Prototype13ComponentProps> = (props) => {
...
Prototype13Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype13Component;
