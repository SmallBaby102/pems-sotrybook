 ...
 * @todo Document this
 */
export interface Prototype27ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype27Component: React.FC<Prototype27ComponentProps> = (props) => {
...
Prototype27Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype27Component;
