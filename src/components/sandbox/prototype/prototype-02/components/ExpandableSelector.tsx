    ...
    return (
        <>
            ...
            <div
                ...
                } bg-white overflow-hidden p-4 mb-2 rounded-2xl border-[1px] border-solid text-[14px] text-[#122B4680] border-[#D3DAEE] ${className}`}
            >
                <div
                    className="flex items-center gap-2 cursor-pointer z-2"
