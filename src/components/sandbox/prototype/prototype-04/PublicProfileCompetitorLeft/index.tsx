...
const ProfileButton: React.FC<{
    ...
    <button
        onClick={onClick}
        className="bg-white flex gap-2 h-[42px] px-4 items-center border-gray-700 border-solid border-[1px] rounded-xl"
    >
        <span>
...
const PublicProfileCompetitorLeft: React.FC<{ desktopMode?: boolean }> = ({
    desktopMode,
}) => {
    ...
    return (
        <div
            className={`bg-[#F1F3F8] overflow-hidden ${
                desktopMode
                    ? "rounded-xl !overflow-auto h-[calc(100vh_-_50px)]"
                    : ""
            }`}
        >
            <div>
                ...
                <div className={`text-center ${desktopMode ? "mt-6" : ""}`}>
                ...
                <div className="flex gap-4 justify-center">
                    <ProfileButton title="Connect" icon={connectIcon} />
                    <ProfileButton title="Message" icon={messageIcon} />
                </div>
                ...
                <div
                    className={`bg-white rounded-t-3xl mt-8 p-6 ${
                        desktopMode ? "!rounded-none p-2 pt-6" : ""
                    }`}
                >
...
export default PublicProfileCompetitorLeft;
