...
const MeasurementCardTypeModal: React.FC<{
    show: boolean;
    onHide: () => void;
    ...
    const list = [
        {
            caption: "Combined Driving Pony",
            id: 1,
        },
        {
            caption: "Combined Driving Pony Temporary",
            id: 2,
        },
        {
            caption: "Dressage Pony",
            id: 3,
        },
        {
            caption: "Dressage Pony Temp.",
            id: 4,
        },

        {
            caption: "Hackney Pony, Roadster Pony",
            id: 5,
        },
        {
            caption: "Hackney Pony, Roadster Pony Temporary ",
            id: 6,
        },
        {
            caption: "Hunter/Jumper Horse or Welsh COB Standard",
            id: 7,
        },
        {
            caption: "Hunter/Jumper Horse or Welsh COB Temporary",
            id: 8,
        },
        {
            caption: "Hunter/Jumper Pony or Welsh  Standard",
            id: 9,
        },
        {
            caption: "Hunter/Jumper Pony or Welsh Temporary",
            id: 10,
        },
        {
            caption: "Saddlebred Pony",
            id: 11,
        },
        {
            caption: "Saddlebred Pony Temporary",
            id: 12,
        },
        {
            caption: "Welsh Pony Permananent",
            id: 13,
        },
        {
            caption: "Welsh Pony Temporary",
            id: 14,
        },
    ];
...
export default MeasurementCardTypeModal;
