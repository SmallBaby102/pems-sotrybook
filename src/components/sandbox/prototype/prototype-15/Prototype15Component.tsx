 ...
 * @todo Document this
 */
export interface Prototype15ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype15Component: React.FC<Prototype15ComponentProps> = (props) => {
...
Prototype15Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype15Component;
