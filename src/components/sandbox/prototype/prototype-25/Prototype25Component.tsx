 ...
 * @todo Document this
 */
export interface Prototype25ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype25Component: React.FC<Prototype25ComponentProps> = (props) => {
...
Prototype25Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype25Component;
