 ...
 * @todo Document this
 */
export interface Prototype19ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype19Component: React.FC<Prototype19ComponentProps> = (props) => {
...
Prototype19Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype19Component;
