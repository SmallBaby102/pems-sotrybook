 ...
 * @todo Document this
 */
export interface Prototype26ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype26Component: React.FC<Prototype26ComponentProps> = (props) => {
...
Prototype26Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype26Component;
