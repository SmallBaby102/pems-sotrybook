 ...
 * @todo Document this
 */
export interface Prototype24ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype24Component: React.FC<Prototype24ComponentProps> = (props) => {
...
Prototype24Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype24Component;
