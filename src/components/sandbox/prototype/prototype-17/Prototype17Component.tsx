 ...
 * @todo Document this
 */
export interface Prototype17ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype17Component: React.FC<Prototype17ComponentProps> = (props) => {
...
Prototype17Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype17Component;
