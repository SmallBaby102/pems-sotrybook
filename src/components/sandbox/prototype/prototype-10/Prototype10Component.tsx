...
import TabSection from "./global/TabSection";

import sponsorOpportunities from "./assets/sponsor-opportunities.svg";
import vendorOpportunities from "./assets/vendor-opportunities.svg";
import eventDetails from "./assets/event-details.svg";
import SponsorVendorEventRow from "./SponsorVendorEventRow";
import { fullDescriptionData } from "./data/fullDescription";
import Prototype01SponsorPrizeList from "./Prototype01SponsorPrizeList";
import CardListForCheckout from "./CardListForCheckout";
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[60%_calc(40%_-_24px)] xl:grid-cols-[68%_calc(32%_-_24px)] 2xl:grid-cols-[72%_calc(28%_-_24px)] gap-6">
                <div>
                    ...
                    <p>
                        The Event at WEF showcases the Olympic sport of show
                        jumping in the betiful lands of Wellington, Florida.
                    </p>
                    <TabSection
                        captions={[
                            "Event Details",
                    ...
                    {currentTab === 0 && (
                        <>
                            ...
                            <RedTitle text="About" />
                            <p className="mt-4 text-[14px] text-[#3C4B7199] leading-8">
                                Come celebrate our 25th anniversary at HITS
                                Commonwealth Park! This year, HITS Culpeper will
                                feature six weeks of USEF competition in the
                                heart of Virginia’s Horse Country. Just one hour
                                from Washington, D.C., HITS Commonwealth Park
                                boasts a 100+ acre permanent horse show facility
                                with 500 permanent stalls, six competition rings
                                and a climate-controlled restaurant. The
                                restaurant includes an outdoor dining deck that
                                overlooks the Grand Prix ring for friends and
                                family to enjoy each day of competition. HITS
                                Culpeper has hosted numerous USEF and USHJA
                                Championships over the years including the USEF
                                Pony Finals, USHJA Zone Team Jumper
                                Championships. and the USHJA Zone 3 Junior
                                Equitation...
                            </p>
                            <MoreButton
                            ...
                            <Prototype01Policies
                                onOverallMore={() =>
                                    setAllPoliciesModalShow(true)
                                }
                            />
                            <HorizantalDivider />
                            <RedTitle text="Staff" className="mb-6" />
                            <Prototype01StaffSection
                                allStaffsModal={() =>
                                    setAllStaffModalShow(true)
                                }
                            />
                            <HorizantalDivider />
                    ...
                    {currentTab === 1 && (
                        <>
                            <RedTitle text="Sponsor event" className="mb-6" />
                            <div className="overflow-auto">
                                <SponsorVendorEventRow
                                    item="Title sponsor"
                                    description="Top spot on event page, top spotevent page event page"
                                    fullDescription={fullDescriptionData}
                                    unitsRemaining={0}
                                    price="$30,000"
                                    value={0}
                            ...
                            <RedTitle
                                text="Sponsor prize list"
                                className="mb-6"
                            />
                            <Prototype01SponsorPrizeList />
                        </>
                    )}
                    {currentTab === 2 && (
                        <>
                            <RedTitle
                                text="Vendor opportunities"
                                className="mb-6"
                            />
                            <div className="overflow-auto">
                                <SponsorVendorEventRow
                        ...
                        {currentTab === 0 ? (
                            ...
                            <>
                                ...
                                <Prototype04Button
                                    ...
                                    bgColor="#00B6AA"
                                    color="white"
                                    className="mt-6 h-[58px] w-[80%] mx-auto block"
                                />
                            </>
                        )}
                    </div>
