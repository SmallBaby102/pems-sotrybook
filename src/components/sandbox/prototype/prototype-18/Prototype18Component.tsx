 ...
 * @todo Document this
 */
export interface Prototype18ComponentProps {
    id: string;
    icon: any;
    name: string;
    mainMetric: any;
 ...
 * @todo Document this
 */
const Prototype18Component: React.FC<Prototype18ComponentProps> = (props) => {
...
Prototype18Component.defaultProps = {
    id: "",
    icon: VariableIcon,
    name: "",
    mainMetric: "",
...
export default Prototype18Component;
